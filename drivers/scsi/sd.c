...
/* ASUS_BSP+++ LandiceFu "[ZE500CL][USB][NA][Spec] Add card reader hotplug support" */
...
//ASUS_BSP+++ LandiceFu "[ZE500CL][Storage][Fix][TT 282020] add delay after read/write disk properties to increase compatibility"
		msleep(100);
//ASUS_BSP--- LandiceFu "[ZE500CL][Storage][Fix][TT 282020] add delay after read/write disk properties to increase compatibility"
	}
